...
if (isset($_POST['submit'])) {
    ...
    create_folder($current_path . $subdir, $thumbs_path . $subdir);
...
// add lang file to session for easy include
    ...
    <head>
        ...
        <?php
        $sprite_lang_file = 'img/spritemap_' . $lang . '.png'; // img/spritemap_en_EN.png
        $sprite_lang_file2 = 'img/spritemap@2x_' . $lang . '.png'; // img/img/spritemap@2x_en_EN.png
        ...
        <style>
            ...
            .dropzone-previews .dz-preview .dz-progress .dz-upload {
                background-image: url('img/spritemap_en_EN.png');
            }
