...
if (!function_exists('response')) {
     ...
     * @return \Response
     */
    function response(string $content = '', int $statusCode = 200, array $headers = array()): Response
    {
...
function checkRelativePathPartial($path): bool
{
 ...
 */
function checkRelativePath(string $path): bool
{
 ...
 */
function isUploadDir(string $path, array $config): bool
{
 ...
 * @return void
 */
function deleteFile(string $path, string $path_thumb, array $config): void
{
 ...
 * @return bool
 */
function rename_file($old_path, $name, $ftp = false, array $config = []): bool
{
 ...
 * @return bool
 */
function rename_folder(string $old_path, string $name, bool $ftp = false, array $config = [])
{
...
function create_img($imgfile, $imgthumb, $newwidth, $newheight = null, $option = "crop", $config = array())
{
    ...
    require_once __DIR__ . '/ImageMagician.php';
    $magicianObj = new ImageMagician($imgfile);
    $magicianObj->resizeImage($newwidth, $newheight, $option);
    $magicianObj->saveImage($imgthumb, 80);
