...
if (!is_dir($thumbs_path)) {
    create_folder(FALSE, $thumbs_path, false, $config);
}
...
<head>
    ...
    <script type="text/javascript"
            src="js/tui-code-snippet.min.js"></script>
    <script type="text/javascript"
            src="js/FileSaver.min.js"></script>
...
<input type="hidden" id="ftp" value="false"/>
                ...
                <div class="nav-collapse collapse">
                    <div class="filters">
                        <div class="row-fluid">
                            ...
                            <div class="span6 entire types"> <!-- 6 -->
                                ...
                                <?php if ($n_files > $config['file_number_limit_js']) { ?>
                                ...
                                <label id="ff-item-type-all" title="<?php echo trans('All'); ?>"
                                       ...
                                       data-item="ff-item-type-all" for="select-type-all" style="margin-right:0;"
        ...
        <div class="span12">
            ...
            <ul class="grid cs-style-2 <?php echo "list-view" . $view; ?>" id="main-item-container">
                ...
                foreach ($files as $file_array) {
                    ...
                    if ($file == '.' || (str_starts_with($file, '.') && isset($file_array['extension']) && $file_array['extension'] == fix_strtolower(trans('Type_dir'))) || (isset($file_array['extension']) && $file_array['extension'] != fix_strtolower(trans('Type_dir'))) || ($file == '..' && $subdir == '') || in_array($file, $config['hidden_folders']) || ($filter != '' && $n_files > $config['file_number_limit_js'] && $file != ".." && stripos($file, $filter) === false)) {
                        continue;
                    }
                    ...
                    if ($file != '..') {
                        if (/*!$ftp && */!file_exists($thumbs_path . $file)) {
                            create_folder(false, $thumbs_path . $file, false, $config);
                        }
                    }
                ...
                if ($file != fix_filename($file, $config)) {
                    ...
                    rename_file($file_path, fix_filename($filename, $config), false, $config);
                    $file = $file1;
