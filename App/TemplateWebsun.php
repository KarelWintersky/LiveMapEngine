...
class TemplateWebsun
{
    ...
    public function __construct( $file , $path , $render_type = 'html')
    {
        ...
        $this->template_real_filepath = Path::create( preg_replace('/^\$/', getenv('PATH.INSTALL'), $path) )->joinName($file)->toString();
    ...
    {
        return in_array($type, $this::ALLOWED_RENDERS, true)
    ...
    public function render()
    {
        ...
        if ($this->render_type === 'html') {
            ...
            if ($this->template_path === '' && $this->template_file === '') {
                return false;
            }
